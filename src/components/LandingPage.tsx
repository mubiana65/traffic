          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            ...
            >
              <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                <span className="block">Smart Traffic</span>
                <span className="block text-blue-400">Control System</span>
              </h1>
              <p className="mt-3 max-w-md mx-auto text-base text-gray-300 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                Advanced traffic management solution for modern cities. Monitor, control, and optimize traffic flow in real-time.
              </p>
            </motion.div>
            ...
            <div className="mt-20 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <p className="text-gray-300">Track traffic conditions and system status in real-time with advanced analytics.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-300">Intelligent traffic light control system that adapts to traffic patterns.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-300">Quick response system for emergency situations and traffic incidents.</p>
              </motion.div>
            </div>
